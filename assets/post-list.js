...
function loadPage(p, nav) {
  ...
  let numDisplayedPosts = p < numPages ? POSTS_PER_PAGE : (numPosts % POSTS_PER_PAGE)
  ...
  if (nav) {
    ...
    // Record the navigation in Google Analytics
    gtag('config', 'UA-131348243-1', {'page_path': document.location.pathname + "?p=" + p});
